...
# 设置页面标题和布局
st.set_page_config(page_title="Backtranslation Rating - Rater 14", layout="centered")
st.title("📝 Simplification Back-Translation Evaluation - Rater 14")
...
# 读取 CSV 文件
df = pd.read_csv("bt_batch_14.csv", encoding="utf-8-sig")
